...
{
    private CreateSaleResult(Guid id, int numberSale, DateTime createdAt, string customer, 
    ...
    public static CreateSaleResult Create(Guid id, string customer, string branchSale, int numberSale, IEnumerable<ItemSale> products,
